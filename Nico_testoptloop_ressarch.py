...
def modelopttest(hyp_param: float, params: Any, i: int, tr: Any, trtest: Any) -> float:
    pass
...
# def mainREGcode_ressarch(tune_val: float, tr: Any, data: Any, algo: str, params: Any) -> Any:
#     pass

def truthdata(data: Any, y_predicted: np.ndarray, params: Any, rawdata: Any, obstrain: List, dstep: int) -> Any:
    pass
