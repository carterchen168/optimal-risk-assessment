...
params.accept_path = os.environ.get('ACCEPT_DIR', '')
params.data_path = os.path.join(os.environ.get('DATA_DIR', ''), 'Data')

params.anomaly_type = ['Adverse Event 1', 'Adverse Event 2', 'Adverse Event 3']
params.load_func = ['Function_1', 'Function_2', 'Function_3']
params.truth_func = ['GTFunc_1', 'GTFunc_2', 'GTFunc_3']
